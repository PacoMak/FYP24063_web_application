...
class TradingSimulator:
    def __init__(
        ...
        self.treasury_rates_file_path = (
            project_root / "src" / "rl_model" / "env" / "10y-treasury-rate.csv"
        )
        treasury_rate = read_treasury_rates(self.treasury_rates_file_path)
        ...
        self.risk_free_rates = pd.read_csv(self.treasury_rates_file_path)
    ...
    def sharpe_ratio(self):
        ...
        risk_free_rates = pd.read_csv(self.treasury_rates_file_path)
